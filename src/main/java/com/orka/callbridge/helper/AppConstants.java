...
public class AppConstants {
	...
	public static final String APP_NAME = "CallBridge";
	public static final String ROLE_CALLER = "ROLE_CALLER";
	public static final String ROLE_ADMIN = "ROLE_ADMIN";
	public static final String ROLE_TL = "ROLE_TL";
	public static final String ROLE_HR = "ROLE_HR";
	public static final String ROLE_OPERATIONS = "ROLE_OPERATIONS";
	public static final String ROLE_SALESOFFICER = "ROLE_SALESOFFICER";
